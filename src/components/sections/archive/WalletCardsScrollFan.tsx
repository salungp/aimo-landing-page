...
/**
 * ARCHIVED — the original scroll-scrubbed wallet deck (410vh / 480vh pinned
 * track, cards scrubbed out of the pocket one per scroll step, desktop fan into
 * four side slots + top-centre, mobile one-card showcase).
 *
 * Superseded on 2026-09-16 by WalletCards.tsx (one-shot stacked pop + divide
 * into the Figma row, node 236:4424). Kept verbatim so the old interaction can
 * be restored: copy this file over ../WalletCards.tsx, rename the export back
 * to `WalletCards`, and fix the two-level relative imports.
 */
...
export default function WalletCardsScrollFan() {
